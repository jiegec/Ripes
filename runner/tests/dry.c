...
#define HZ 1000000 /* If your system doesn't have this, use -DHZ=xxx */
#else
	*** You must define HZ!!! ***
#endif /* HZ */
#ifndef PASS2
  ...
  /* Main and Proc_0 in the Ada version             */
{
  ...
  Rec_Type Tmp1;
  Rec_Type Tmp2;
  Next_Ptr_Glob = (Rec_Pointer) &Tmp1;
  Ptr_Glob = (Rec_Pointer) &Tmp2;
  ...
  Arr_2_Glob [8][7] = 10;
    ...
    print_str ("Trying runs through Dhrystone: ");
  ...
  print_str ("\n        should be:   B");
  print_str ("\nArr_1_Glob[8]:       ");
  print_int (Arr_1_Glob[8]);
  print_str ("\n        should be:   7");
  print_str ("\nArr_2_Glob[8][7]:    ");
  print_int (Arr_2_Glob[8][7]);
  print_str ("\n        should be:   Number_Of_Runs + 10\n");
  print_str ("Ptr_Glob->");
  print_str ("\n  Ptr_Comp:          ");
  print_int ((int) Ptr_Glob->Ptr_Comp);
  print_str ("\n        should be:   (implementation-dependent)");
  print_str ("\n  Discr:             ");
  print_int (Ptr_Glob->Discr);
  print_str ("\n        should be:   0");
  print_str ("\n  Enum_Comp:         ");
  print_int (Ptr_Glob->variant.var_1.Enum_Comp);
  print_str ("\n        should be:   2");
  print_str ("\n  Int_Comp:          ");
  print_int (Ptr_Glob->variant.var_1.Int_Comp);
  print_str ("\n        should be:   17");
  print_str ("\n  Str_Comp:          ");
  print_str (Ptr_Glob->variant.var_1.Str_Comp);
  print_str ("\n        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
  print_str ("\nNext_Ptr_Glob->");
  print_str ("\n  Ptr_Comp:          ");
  print_int ((int) Next_Ptr_Glob->Ptr_Comp);
  print_str ("\n        should be:   (implementation-dependent), same as above");
  print_str ("\n  Discr:             ");
  print_int (Next_Ptr_Glob->Discr);
  print_str ("\n        should be:   0");
  print_str ("\n  Enum_Comp:         ");
  print_int (Next_Ptr_Glob->variant.var_1.Enum_Comp);
  print_str ("\n        should be:   1");
  print_str ("\n  Int_Comp:          ");
  print_int (Next_Ptr_Glob->variant.var_1.Int_Comp);
  print_str ("\n        should be:   18");
  print_str ("\n  Str_Comp:          ");
  print_str (Next_Ptr_Glob->variant.var_1.Str_Comp);
  print_str ("\n        should be:   DHRYSTONE PROGRAM, SOME STRING\n");
  print_str ("\nInt_1_Loc:           ");
  print_int (Int_1_Loc);
  print_str ("\n        should be:   5");
